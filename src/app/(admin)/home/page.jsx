  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <main className="flex-1 p-6 space-y-8">
        {/* Search */}
        <section className="relative w-full flex justify-center" ref={searchBox}>
        ...
        <section className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="bg-green-100 shadow rounded-xl p-6 min-h-[160px] flex flex-col justify-between">
            ...
            <p className="mt-2 text-4xl font-semibold text-green-700">{approved}</p>
          </div>
          <div className="bg-yellow-50 shadow rounded-xl p-6 min-h-[160px] flex flex-col justify-between">
            ...
            <p className="mt-2 text-4xl font-semibold text-yellow-700">{pending}</p>
          </div>
          <div className="bg-blue-100 shadow rounded-xl p-6 min-h-[160px] flex flex-col justify-between">
            ...
            <p className="mt-2 text-4xl font-semibold text-blue-700">{newest}</p>
          </div>
        </section>
        ...
        <section className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-6 space-y-4">
            <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <h2 className="text-xl font-semibold text-gray-800">Loan Requests</h2>
              <select
  value={rangeKey}
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs text-gray-500">
                      Submitted at: <strong>{new Date(loan.createdAt).toLocaleDateString("en-GB", {
                        year: "numeric",
                        month: "short",
                        day: "numeric",
                      })}</strong>
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-full grid place-items-center">
        <span className="text-blue-500 text-sm font-bold">{idx + 1}</span>
      </div>
...
{showCreate && (
  ...
  >
    ...
    >
      ...
      <h3 className="text-xl font-bold text-gray-800 mb-4">Create Loan Category</h3>
