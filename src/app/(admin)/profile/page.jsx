        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            ...
            <div className="mt-6 md:mt-8 flex justify-end">
              <Button className="w-full sm:w-48 bg-blue-700 hover:bg-blue-800 text-white h-10 md:h-11" type="submit">
                Save Changes
              </Button>
            </div>
          </CardContent>
  ...
  <CardContent className="space-y-4 md:space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-4">
      ...
      <Select value={docUploadPref} onValueChange={setDocUploadPref}>
        <SelectTrigger className="w-40 capitalize bg-white h-10 md:h-11">
          {docUploadPref === "ask"
            ? "Always ask"
            : docUploadPref === "agree"
            ? "Always agree"
        ...
        <SelectContent>
          <SelectItem value="ask" className="capitalize">Always ask</SelectItem>
          <SelectItem value="agree" className="capitalize">Always agree</SelectItem>
          <SelectItem value="never" className="capitalize">Never</SelectItem>
        </SelectContent>
      </Select>
    </div>
